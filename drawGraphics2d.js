...
function drawTicks(board, axis, json, length, index) {
    ...
    attr.generateLabelText = function (tick, zero) {
        var n = +(tick.usrCoords[coordIndex + 1] - zero.usrCoords[coordIndex + 1]).toFixed(10);
...
drawGraphics2d("graphics2d", {
  ...
  "elements": [{
    ...
    "option": "color",
    "value": [0.36841699481010437, 0.5067790150642395, 0.7097979784011841]
  }, {
    "option": "opacity",
    "value": 1.0
  }, {
    ...
    "option": "color",
    "value": [0.8807219862937927, 0.6110410094261169, 0.14205099642276764]
  }, {
    "option": "opacity",
    "value": 1.0
  }, {
